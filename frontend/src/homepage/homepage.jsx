        ...
        <div className="homepage">
            <div className="section">
                ...
                <div className="inputs">
                    ...
                    <div type="text" className="semestre_input" style={semestre?{border:"3px solid black",fontSize:"20px",color:"black"}:{border:"3px solid #F5841F"}} onClick={()=>{setshow_semestres(true);setshow_subjects(false)}}>{semestre?semestre:"CHOOSE A SEMESTRE"}</div>
                    <div type="text" className="semestre_input" style={subject?{border:"3px solid black",fontSize:"20px",color:"black"}:{border:"3px solid #F5841F"}} onClick={()=>{setshow_subjects(true);setshow_semestres(false)}}>{subject?subject:"CHOOSE A SEMESTRE"}</div>
                </div>
