        ...
        <div className="homepage">
            <div className="section">
                ...
                <div className="inputs">
                    ...
                    <input type="text" className="semestre_input" style={semestre?{border:"3px solid black"}:{border:"3px solid #F5841F"}} value={semestre} placeholder="CHOOSE A SEMESTRE" onClick={()=>{setshow_semestres(true);setshow_subjects(false)}}/>
                    <input type="text" className="semestre_input" style={subject?{border:"3px solid black"}:{border:"3px solid #F5841F"}} value={subject} placeholder="CHOOSE A SUBJECT" onClick={()=>{setshow_subjects(true);setshow_semestres(false)}}/>
                </div>
                        ...
                        <i onClick={()=>setshow_contribute(false)} class="show_contribute fa-solid fa-xmark"></i>
                            <div className="add_new_inputs">
                                ...
                                <div style={{position:"relative"}}>
                                    ...
                                    <input type="text" placeholder="Semestre" onClick={()=>setshowS(!showS)} value={req_semestre}/>
                                </div>
                                {showS && 
                                ...
                                <div style={{position:"relative"}}>
                                    ...
                                    <input type="text" placeholder="Subject" onClick={()=>setshowSubject(!showSubject)} value={req_subject}/>
                                </div>
                                ...
                                <div style={{position:"relative"}}>
                                    ...
                                    <input type="text" placeholder="Type" onClick={()=>setshowType(!showType)} value={req_type}/>
                                </div>
                                {showType && 
                                <div className="semestres" style={{width:"385px",position:"relative",top:"-7px"}} onClick={(e)=>e.stopPropagation()}>
                                ...
                                <input type="text" placeholder="Teacher" onChange={(e)=>setreq_teacher(e.target.value)}/>
                            </div>
