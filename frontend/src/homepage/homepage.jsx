        ...
        <div className="homepage">
            <div className="section">
                ...
                <div className="inputs">
                    ...
                    <input type="text" className="semestre_input" style={semestre?{border:"3px solid black"}:{border:"3px solid #F5841F"}} value={semestre} placeholder="Choose a semsetre" onClick={()=>{setshow_semestres(true);setshow_subjects(false)}}/>
                    <input type="text" className="semestre_input" value={subject} placeholder="Choose a subject" onClick={()=>{setshow_subjects(true);setshow_semestres(false)}}/>
                </div>
                    ...
                    <div style={{position:"absolute",top:0,height:"100vh",width:"100vw",left:0,backgroundColor:"rgba(0, 0, 0, 0.4)",display:"flex",justifyContent:"center",alignItems:"center"}} className="new_interface">
                        ...
                        <i onClick={()=>setshow_contribute(false)} class="show_contribute fa-solid fa-xmark"></i>
                            <div className="add_new_inputs">
                                ...
                                <input type="text" placeholder="Semestre" onClick={()=>setshowS(true)} value={req_semestre}/>
                                {showS && 
                                ...
                                <input type="text" placeholder="Subject" onClick={()=>setshowSubject(true)} value={req_subject}/>
                                ...
                                <input type="text" placeholder="Type" onClick={()=>setshowType(true)} value={req_type}/>
                                {showType && 
                                <div className="semestres" style={{width:"385px",position:"relative",top:"-7px"}} onClick={(e)=>e.stopPropagation()}>
